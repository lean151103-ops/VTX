...
HD_PWD='D:/Xilinx/Xlinx_project/test_uart_23-1/test_uart_23-1.runs/design_1_wrapper_tx_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_wrapper_tx_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_wrapper_tx_fifo_0_0.tcl
