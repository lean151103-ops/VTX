...
# Design libraries
design_libs=(simprims_ver xil_defaultlib fifo_generator_v13_2_7 xlconstant_v1_1_7)
...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../test_uart_23-1.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"../../../../test_uart_23-1.gen/sources_1/bd/design_1/ipshared/7698" \
       -input simulate.do
}
