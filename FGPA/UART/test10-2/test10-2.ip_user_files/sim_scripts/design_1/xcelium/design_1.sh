...
# Design libraries
design_libs=(simprims_ver xil_defaultlib fifo_generator_v13_2_7 axis_infrastructure_v1_1_0 axis_data_fifo_v2_0_9 xlconstant_v1_1_7)
...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../test10-2.gen/sources_1/bd/design_1/ipshared/8713/hdl" \
       +incdir+"$ref_dir/../../../../test10-2.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"../../../../test10-2.gen/sources_1/bd/design_1/ipshared/8713/hdl" \
       +incdir+"../../../../test10-2.gen/sources_1/bd/design_1/ipshared/7698" \
       -input simulate.do
}
