...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L fifo_generator_v13_2_7 -L axis_infrastructure_v1_1_0 -L axis_data_fifo_v2_0_9 -L xlconstant_v1_1_7 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Xlinx/Vivado/2022.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
